...
RAFTicker.onTick = (timestamp) => {
    ...
    RAFTicker._dispatcher.dispatchEvent(new RAFTickerEvent(RAFTickerEventType.onBeforeTick, timestamp, delta));
    RAFTicker._dispatcher.dispatchEvent(new RAFTickerEvent(RAFTickerEventType.tick, timestamp, delta));
    RAFTicker._dispatcher.dispatchEvent(new RAFTickerEvent(RAFTickerEventType.onAfterTick, timestamp, delta));
    RAFTicker._lastUpdateTimestamp = timestamp;
